...
class User(AbstractUser, BaseModel):
    ...
    photo = models.ImageField(upload_to='user_photos/', null=True, blank=True, 
                              validators=[FileExtensionValidator(allowed_extensions=['jpg','png','jpeg','heic','heif'])])
...
# email -> google@gmail.com -> save()


PHONE_EXPIRE = 2 # register with phone number (limit time is 2)
EMAIL_EXPIRE = 5 # register with email (limit time is 5)   
...
class UserConfirmation(BaseModel):
    ...
    def save(self, *args, **kwagrs):
        ...
        super(UserConfirmation, self).save(*args, **kwagrs)